...
function r_parse$1(n,max_place) {
  ...
  if (max_place==1 || n in numbers$1) return numbers$1[n];
  for (var i=max_place; i>=1; i/=10)
  {
    if (i in numbers$1)
    {
...
function parseNumber$1(n){
  ...
  out=out+r_parse$1(n,1000000000000000);
  return out.trim();
}
...
function r_parse$2(n,max_place) {
  ...
  if (max_place==1 || n in numbers$2) return numbers$2[n];
  for (var i=max_place; i>=1; i/=10)
  {
    if (i in numbers$2)
    {
      ...
      if (ndivi>0)
      {
        ...
        return(
          r_parse$2(ndivi,max_place/i)+
          numbers$2[i]+
          ((nmodi!=0 && next>nmodi)?zero$2:"")+
          ((nmodi==10)?numbers$2[1]+numbers$2[10]:r_parse$2(nmodi,i))
          );
      }
    }
  }
...
function parseNumber$2(n) {
  ...
  out=out+r_parse$2(n,1000000000000000);
  return out.trim();
}
...
function parse100s(n){
  return numbers$3[Math.floor(n/100)*100] + ' ' + parse10s(parseInt(n.toString().substr(1,2)), true);
}
...
function parse1000sAndGreater(n){
  ...
  out = my.parseNumber(nStr.substr(0,3)) + ' ' + numbers$3[Math.pow(10, ctr)] + ' ' + out;
  return out;
}
...
function parse10s$1(n, ignore0){
  ...
  if (n == 0 && ignore0){
    ...
    if (n % 10 == 0){
      ...
      out = getPlace$1(n,1,1) + ("23".indexOf(lastNumber) >= 0 ? numbers$4.conjunctionDieresis : numbers$4.conjunction) + getPlace$1(n,0,10);
    }
  }
  return out;
}
...
function parseGreaterThanOrEqualTo10000(n){
  ...
  out = my.parseNumber(nStr.substr(0,3)) + ' ' + numbers$4[Math.pow(10, ctr)] + ' ' + out;
  return out;
}

function andSingle$1(n){
  return numbers$4.conjunction+ ' ' + my.parseNumber(n);
}
...
function parseGreaterThanOrEqualTo1000(n){
  ...
  out = my.parseNumber(nStr.substr(0,3)) + ' ' + numbers$5[Math.pow(10, ctr)] + ' ' + out;
  return out;
}

function andSingle$2(n){
  return numbers$5.conjunction+ ' ' + my.parseNumber(n);
}
...
function parseGreaterThanOrEqualTo1000$1(n){
  ...
  out = my.parseNumber(nStr.substr(0,3)) + ' ' + numbers$6[Math.pow(10, ctr)] + ' ' + out;
  return out;
}

function andSingle$3(n){
  return numbers$6.conjunction+ ' ' + my.parseNumber(n);
}
...
**********************************************************************/
  ...
  function r_parse$3(n,max_place,feminine) {
    ...
    if (n<1000)
    {
      return numbers$8[Math.floor(n/100)]+numbers$8[100]+r_parse$3(n%100,false)+(feminine?" ":"");
    }
    for (var i=max_place; i>=1000; i/=1000)
    {
      ...
      if (mdivi>0)
      {
        return r_parse$3(mdivi,100,i>1000)+numbers$8[i]+r_parse$3(n%i,i/1000,false);
      }
    }
  }
...
function parseNumber$8(n) {
  if (n==0) return "null";
  if (n>10000000000000000-1) return "unbound";
  if (n>1000 && n in numbers$8) return one_feminine+" "+numbers$8[n];
  var out = '';
  ...
  out=out+r_parse$3(n,1000000000000000,n>1000);
  return out.trim();
}
...
function parseGreaterThanOrEqualTo1000$3(n){
  ...
  out = my.parseNumber(nStr.substr(0,3)) + ' ' + numbers$9[Math.pow(10, ctr)] + ' ' + out;
  return out;
}

function andSingle$4(n){
  return numbers$9.conjunction+ ' ' + my.parseNumber(n, true);
}
...
function parseGreaterThanOrEqualTo1000$4(n){
  ...
  while (nStr.length > 3){
    ...
    else if (piece < 100 && numbers$10.hasSingle){
  ...
  out = my.parseNumber(nStr.substr(0,3)) + ' ' + numbers$10[Math.pow(10, ctr)] + ' ' + out;
  return out;
}
...
function parseGreaterThanOrEqualTo1000$5(n){
  ...
  out = my.parseNumber(nStr.substr(0,3)) + ' ' + numbers$12[Math.pow(10, ctr)] + ' ' + out;
  return out;
}

function andSingle$5(n){
  return numbers$12.conjunction+ ' ' + my.parseNumber(n);
}
...
function parseGreaterThanOrEqualTo1000$6(n){
  ...
  out = my.parseNumber(nStr.substr(0,3)) + ' ' + numbers$13[Math.pow(10, ctr)] + ' ' + out;
  return out;
}

function andSingle$6(n){
  return numbers$13.conjunction+ ' ' + my.parseNumber(n);
}
...
function parseGreaterThanOrEqualTo1000$7(n){
  ...
  out = my.parseNumber(nStr.substr(0,3)) + ' ' + numbers$14[Math.pow(10, ctr)] + ' ' + out;
  return out;
}
...
function parseGreaterThanOrEqualTo1000$8(n){
  ...
  out = my.parseNumber(nStr.substr(0,3)) + ' ' + numbers$15[Math.pow(10, ctr)] + ' ' + out;
  return out;
}

function andSingle$7(n){
  return numbers$15.conjunction+ ' ' + my.parseNumber(n);
}
...
function parseGreaterThanOrEqualTo1000$9(n){
  ...
  out = my.parseNumber(nStr.substr(0,3)) + numbers$16[Math.pow(10, ctr)] + out;
  return out;
}

function andSingle$8(n){
  return numbers$16.conjunction + my.parseNumber(n);
}
...
var languages = {
  ...
  dutch,
  emoji: parseNumber$4,
  english: parseNumber$5,
  estonian: parseNumber$6,
  french: parseNumber$7,
  german: parseNumber$8,
  icelandic: parseNumber$9,
  italian: parseNumber$10,
  japaneseHiragana: parseNumber$11,
  japaneseKanji: parseNumber$12,
  japaneseRomaji: parseNumber$13,
  norwegian: parseNumber$14,
  portuguese: parseNumber$15,
  russian: parseNumber$16,
  spanish: parseNumber$17,
  swedish: parseNumber$18
};
